...
from MemSE.nas import AccuracyDataset, ResNetArchEncoder, AccuracyPredictorFactory, MemSEProblem
...
print('Loaded')
problem = MemSEProblem(memse, encoder, predictor, const=args.const_gmax)
...
torch.save(results, f'{save_path}/ga_results_pymoo{"_const" if args.const_gmax else ""}_{args.predictor}.pth')
