...
from .triton_conv_utils import conv_heuristics, _unpack
...
def _kernel_delta_x_hwc(
    ...
    # offset for the initial ptr for x and a
    off_x_n = off_y_n
    ...
    tl.atomic_add(p_ptrs, acc_p_n, mask=mask_p)
...
@conv_heuristics()
@triton.jit
def _kernel_delta_x(  # conv1x1 or padding==0
    x,
    w,
    y,
    # stride of tensor
